// Downloaded from https://github.com/google/brotli/blob/master/js/decode.js
...
function BrotliDecodeClosure() {
  ...
  function initState(s, input) {
    ...
    s.blockTrees[0] = 7;
    s.distRbIdx = 3;
    var /** number */ maxDistanceAlphabetLimit = calculateDistanceAlphabetLimit(
      0x7ffffffc,
      3,
      15 << 3
    );
  ...
  function decodeBlockTypeAndLength(s, treeType, numBlockTypes) {
    ...
    var /** number */ result = readBlockLength(
      s.blockTrees,
      2 * treeType + 1,
      s
    );
  ...
  function decodeLiteralBlockSwitch(s) {
    s.literalBlockLength = decodeBlockTypeAndLength(
      s,
      0,
      s.numLiteralBlockTypes
    );
  ...
  function decodeCommandBlockSwitch(s) {
    s.commandBlockLength = decodeBlockTypeAndLength(
      s,
      1,
  ...
  function readMetablockHuffmanCodesAndContextMaps(s) {
    ...
    s.distanceBlockLength = readMetablockPartition(
      s,
      2,
      s.numDistanceBlockTypes
    );
    ...
    var /** number */ numLiteralTrees = decodeContextMap(
    ...
    var /** number */ numDistTrees = decodeContextMap(
    ...
    var /** number */ distanceAlphabetSizeMax = calculateDistanceAlphabetSize(
      ...
      switch (s.runningState) {
        ...
        case 7:
          if (s.trivialLiteralContext != 0) {
            ...
            var /** number */ prevByte1 =
              ringBuffer[(s.pos - 1) & ringBufferMask] & 0xff;
            var /** number */ prevByte2 =
  ...
  function buildHuffmanTable(
    ...
    for (
      var /** number */ len = rootBits + 1, step = 2;
      len <= 15;
      len++, step <<= 1
    ) {
      for (; count[len] > 0; count[len]--) {
...
/** @export */
module.exports = { default: BrotliDecodeClosure() };
